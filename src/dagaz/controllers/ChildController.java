    ...
    private void closeDialog() {
        ...
        try {
            ...
            if (ttlDialog.getText().equals("...")) {
                driver.findElement(By.xpath("//div[@class=''ui-dialog-buttonset]/button[@class='ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-focus']")).click();
            }
        } catch (Exception ex) {
        }
    }
